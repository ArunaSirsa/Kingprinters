        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaperQualityId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourierPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourierPrices_PaperQualities_PaperQualityId",
                        column: x => x.PaperQualityId,
                        principalTable: "PaperQualities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourierPrices_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourierPrices_PaperQualityId",
                table: "CourierPrices",
                column: "PaperQualityId");

            migrationBuilder.CreateIndex(
                name: "IX_CourierPrices_StateId",
                table: "CourierPrices",
                column: "StateId");
